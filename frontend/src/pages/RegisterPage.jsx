...
export const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!passwordRegex.test(formData.password)) {
      setError('Password must contain min 8 chars, 1 uppercase, 1 lowercase, 1 number, and 1 special char.');
      return;
    }
      ...
      <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-md border border-slate-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input type="text" required className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500"
          ...
          <button type="submit" className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-2 px-4 rounded-lg transition duration-200">
            Register
          </button>
        </form>
